...
const DatePickerComponent: React.FC<IProps> = ({ formFieldName, control, label, dateFormat, autoSubmit, submitFunction, size }) => {
    ...
    return (
        <Controller
            name={formFieldName}
            control={control}
            rules={{ validate: value => value === null || moment(value, dateFormat, true).isValid() || t("validation.incorrectDate") as string }}
